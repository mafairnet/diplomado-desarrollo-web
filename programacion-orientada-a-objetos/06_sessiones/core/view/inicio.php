<html>
    ...
    <body>
        <main class="form-signin text-center">
            ...
            <p>Esta es nuestra pagina de incio, enhorabuena estas logueado!</p>

            <a href="index.php?view=calculadora"><button class="w-100 btn btn-lg btn-primary" >Usar Calculadora</button></a>
            <br/><br/>
